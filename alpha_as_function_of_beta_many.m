...
for s = 0:8
    ...
    try
        [alphas,betas] = beta_vary_load_lastalpha(savefilename);
...
errorbar(betas,alphas_default_mean,alphas_default_err,'ks-','LineWidth',3);
...
errorbar(betas,alphas_d0p001_mean,alphas_d0p001_err,'bs-','LineWidth',3);
